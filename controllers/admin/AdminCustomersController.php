...
//                    'disabled' => $obj->id ? true: false,
                    ...
                    'button' => array(
                        'label' => $this->trans('SUNAT&nbsp;<i class="icon-search" style="color: #fff!important;"></i>', array(), 'Admin.Advparameters.Feature'),
                        'class' => 'sunat-button',
                        'attributes' => array(
...
//        d($this);
    ...
    public function renderView()
    {
        ...
        for ($i = 0; $i < $total_carts; $i++) {
            ...
            $carts[$i]['orderId'] = Order::getIdByCartId((int)$carts[$i]['id_cart']);
        }
