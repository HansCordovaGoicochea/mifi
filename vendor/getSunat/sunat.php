<?php
	...
	class Sunat{
		...
		{
//            $image = $this->cc->send('https://e-consultaruc.sunat.gob.pe/cl-ti-itmrconsruc/captcha?accion=image');  //download image
//            file_put_contents('captcha.jpg', $image);  //put it to captcha.jpg
//            exec('"C:\\Program Files\\Tesseract-OCR\\tesseract" "captcha.jpg" out');
//            $srr = file_get_contents("out.txt");
//            $numRand = preg_replace("/[^a-zA-Z0-9]+/", "", $srr);
//            var_dump($result);
//            die();
